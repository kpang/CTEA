## 30 sets of ASD and DD genes expressed in any subtypes of adolescent telencephalon projecting excitatory neurons.
...
## Background genes for each cell subtype.

## The file "cell_type_1.txt" contains orders in which the subtypes of adolescent telencephalon projecting excitatory neurons are shown in the plot.
...
## Top 10% of genes with the highest expression levels in each cell subtype.
...
## 30 sets of ASD and DD genes expressed in any cell subtypes.
...
## Size of 30 sets of ASD and DD genes expressed in any cell subtypes.
...
## Calculate overlap between 30 ASD and DD gene sets and the top 10% of genes highly expressed in each cell subtype.
