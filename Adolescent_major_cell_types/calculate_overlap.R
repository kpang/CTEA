## 30 sets of ASD and DD genes expressed in any of 30 major cell types of adolescent mouse nervous system.
...
## The file "cell_type_1.txt" contains orders in which the 30 major cell types are shown in the plot.
