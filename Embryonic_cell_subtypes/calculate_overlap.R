## 30 sets of ASD and DD genes expressed in any subtypes of embryonic neurons.
...
## The file "cell_type_1.txt" contains orders in which the subtypes of embryonic neurons are shown in the plot.
